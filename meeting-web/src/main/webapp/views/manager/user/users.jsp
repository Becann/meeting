...
<head>
    ...
    <!-- bootstrap -->
	<link href="<%=path%>/bootstrap/bootstrap-table.min.css" rel="stylesheet">
...
<body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <table data-toggle="table" data-pagination="true">
                            <thead>
                                <tr>
                                    <th data-align="left">操作</th >
                                    <th data-align="left">用户名</th>
                                    <th data-align="left">用户角色</th>
                                    <th data-align="left">注册时间</th>
                                </tr>
                            </thead>
                            <tbody>
                            <c:forEach items="${userlist}" var="user">																							
                                <tr >
                                <td>
                                     <a   class="btn btn-white btn-sm" onclick="deleteUser(${user.id})" >                                         
    ...
    <!-- bootstrap tables -->
    <script src="<%=path%>/bootstrap/bootstrap-table.min.js"></script>
    <script src="<%=path%>/bootstrap/bootstrap-table-zh-CN.min.js"></script>
